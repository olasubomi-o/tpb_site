...
function getSlug(study: CaseStudy): string {
            ...
            <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 40px" }}>
              ...
              <div style={{ borderTop: "1px solid var(--border)" }}>
                {featuredStudies.map((study, i) => (
                  <CaseStudyCard key={study._id} study={study} index={i} inView={featuredInView} large />
                ))}
              </div>
            </div>
          </section>
            ...
            <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 40px" }}>
              ...
              <div style={{ borderTop: "1px solid var(--border)" }}>
                {otherStudies.map((study, i) => (
                  <CaseStudyCard key={study._id} study={study} index={i} inView={allInView} />
                ))}
              </div>
            </div>
          </section>

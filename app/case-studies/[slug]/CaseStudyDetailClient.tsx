  ...
  return (
    <>
      ...
      <main>
        ...
        >
          <div
            style={{ maxWidth: 1280, margin: "0 auto", padding: "0 40px", display: "grid", gridTemplateColumns: "1fr 2fr", gap: 80, alignItems: "start" }}
          ...
          >
            ...
            <motion.p
              ...
              style={{ fontFamily: "var(--font-body)", fontSize: "clamp(16px, 1.4vw, 20px)", fontWeight: 400, color: "var(--text-muted)", lineHeight: 1.8 }}
            >
              {study.challenge}
            </motion.p>
          </div>
          ...
          <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 40px" }}>
            ...
            <div style={{ borderTop: "1px solid var(--border)" }}>
              {study.outcomes.map((outcome, i) => (
                ...
                >
                  <span style={{ fontFamily: "var(--font-display)", fontSize: "clamp(28px, 3vw, 48px)", fontWeight: 700, color: "var(--text-dim-heading)", letterSpacing: "-0.02em", lineHeight: 1 }}>
                    {String(i + 1).padStart(2, "0")}
                  </span>
                  <p style={{ fontFamily: "var(--font-body)", fontSize: "clamp(16px, 1.4vw, 20px)", fontWeight: 400, color: "var(--text)", lineHeight: 1.6, paddingTop: 8 }}>
                    {outcome}
                  </p>
                </motion.div>
              ))}
                ...
                {related.map((s, i) => (
                  ...
                  >
                    ...
                    <div style={{ padding: "32px 36px 36px", flex: 1, display: "flex", flexDirection: "column" }}>
                      <p style={{ fontFamily: "var(--font-display)", fontSize: 10, fontWeight: 400, letterSpacing: "0.14em", textTransform: "uppercase", color: "var(--text-muted)", marginBottom: 12 }}>
                        {s.client}
                      </p>
                      ...
                      <Link
                        href={`/case-studies/${s.id?.current ?? ""}`}
        ...
        <section
          ref={ctaRef}
          style={{ background: "var(--bg-secondary)", padding: "160px 40px", borderBottom: "1px solid var(--border)", position: "relative", overflow: "hidden" }}
        >
          {[
            ...
            <div key={i} style={{ position: "absolute", width: 40, height: 40, pointerEvents: "none", ...s }} />
          ))}
          ...
          <div style={{ position: "relative", zIndex: 1, maxWidth: 900, margin: "0 auto", textAlign: "center" }}>
            ...
            >
              ...
              <h2 style={{ fontFamily: "var(--font-display)", fontSize: "clamp(28px, 4vw, 56px)", fontWeight: 700, lineHeight: 1.1, letterSpacing: "-0.01em", color: "var(--text)", textTransform: "uppercase", maxWidth: 700, margin: "0 auto 32px" }}>
                Want Results{" "}
                <span style={{ color: "#FF3000" }}>Like These?</span>
              </h2>

              <p style={{ fontFamily: "var(--font-body)", fontSize: 16, fontWeight: 400, color: "var(--text-muted)", maxWidth: 480, margin: "0 auto 56px", lineHeight: 1.7 }}>
              ...
              <a
                href="/#contact"
                style={{ display: "inline-flex", alignItems: "center", gap: 12, background: "#F5F5F0", color: "#080808", fontFamily: "var(--font-display)", fontSize: 11, fontWeight: 700, letterSpacing: "0.14em", textTransform: "uppercase", padding: "18px 40px", textDecoration: "none", minHeight: 56, border: "1px solid #F5F5F0" }}
                onMouseEnter={(e) => { (e.currentTarget as HTMLElement).style.background = "#FF3000"; (e.currentTarget as HTMLElement).style.borderColor = "#FF3000"; }}
                onMouseLeave={(e) => { (e.currentTarget as HTMLElement).style.background = "#F5F5F0"; (e.currentTarget as HTMLElement).style.borderColor = "#F5F5F0"; }}
              >

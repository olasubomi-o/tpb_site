...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    headline:
      "A Platform That Diagnoses Your CV in 30 Seconds and Rewrites It to Get You Hired",
    challenge:
  ...
  },
  {
    ...
    duration: "End-to-end engagement",
    headline:
      "An AI Analytics Layer That Delivers Instant Data Insights Where Your Team Already Works",
    challenge:
    ...
    approach:
      "We designed and built Dex AI as a conversational analytics layer that integrates directly into Slack and Microsoft Teams — meeting teams in the tools they already use rather than asking them to adopt another dashboard. The core is plain English: ask a question, get a chart, get an insight, ask a follow-up. Claude Opus 4.6 powers the conversational intelligence, handling context-aware follow-ups that preserve the thread of an analysis across a full conversation rather than treating each question in isolation. A Golang backend manages data workflow orchestration and query execution at speed, with automated chart generation surfacing visual answers without requiring a human analyst in the loop. PostgreSQL handles structured data persistence, and a Next.js layer supports any web-based configuration and management surfaces.",
    outcomes: [
  ...
  {
    id: "ranti-ai-business-assistant",
    client: "Ranti AI",
    ...
    duration: "End-to-end engagement",
    headline:
      "An AI Business Assistant That Turns Organizational Knowledge Into Instant, Actionable Answers",
    challenge:
